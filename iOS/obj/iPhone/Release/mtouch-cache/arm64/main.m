...
extern void *mono_aot_module_FormsPinView_PCL_info;
...
extern void *mono_aot_module_HockeySDK_iOSBindings_info;
...
void xamarin_register_modules_impl ()
{
	...
	mono_aot_register_module (mono_aot_module_FormsPinView_PCL_info);
	...
	mono_aot_register_module (mono_aot_module_HockeySDK_iOSBindings_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "XamarinClient.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
